      ...
      <div className='m-5'>
        ...
        <form className='grid border-3 rounded-lg p-4 m-4 border-b-blue-900 border-t-red-800 border-r-red-800 border-l-blue-800 '
          ...
          >
            ...
            <option value="controllore_qualita">controllore qualità</option>
            <option value="azienda_trasformazione">azienda trasformazione</option>
